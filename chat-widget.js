...
(function() {
    ...
    const defaultSettings = {
        ...
        branding: {
            ...
            responseTimeText: '',
            poweredBy: {
                text: 'Powered by IgniteIPA',
                link: 'https://igniteipa.ai'
            }
        },
        style: {
    ...
    const welcomeScreenHTML = `
        ...
        <div class="user-registration">
            <h2 class="registration-title">Let’s get to know you before we begin. Just a few quick details!</h2>
    ...
    launchButton.innerHTML = `
        ...
        <span class="chat-launcher-text">Can I Assist?</span>`;
